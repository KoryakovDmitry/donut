...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_model_name_or_path", type=str, default="config/ziffer")
    parser.add_argument("--dataset_name_or_path", type=str, default="dataset/nano_ziffer")
    parser.add_argument("--split", type=str, default="test")
    parser.add_argument("--task_name", type=str, default="<s_nano_ziffer>")
